...
- **Города** с позывными-названиями (Альфа-1, Браво-2…) и **сеть дорог**
  между ними.
...
## Что дальше (этап 2: редактор)

Следующий шаг — **ручное редактирование** карты поверх генерации:

- кисти для рисования леса/воды/полей мышью;
- расстановка и переименование городов и объектов вручную;
- добавление военных условных знаков (высоты, мосты, отдельные строения);
- сохранение/загрузка карты в файл (не только картинкой, но и проектом).
