...
- **Детальные города** с позывными-названиями (Альфа-1, Браво-2…): не просто
  точки, а настоящая застройка — пятно города, сеть улиц, кварталы и
  дома-прямоугольники. Есть зонирование: центр (гражданские здания), жилая
  застройка, промзона на окраине и центральная площадь.
