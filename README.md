...
- **Города — КВАРТАЛАМИ, как на настоящих картах.** Сетка улиц делит пункт на
  кварталы; внутри квартала застройка идёт **по периметру** (дома фасадами на
  улицу, внутри — двор), а часть кварталов — **парки/скверы** (от маленьких
  скверов до крупных парков в несколько кварталов). Город делится на **районы с
  разным углом сетки** (компактное ядро и повёрнутые относительно него
  окраины) — поэтому он не выглядит одной ровной решёткой. Главные улицы
  («проспекты») шире обычных. Если через город течёт **река** или он стоит у
  воды — кварталы выходят на **набережную** (зелёную), обычные улицы упираются
  в берег, а проспекты пересекают воду **мостами**. Есть зонирование: центр (гражданские здания и
  **центральная площадь**), жилые кварталы, промзона с крупными корпусами на
  окраине; чем дальше от центра — тем больше парков. Размер и число кварталов
  зависят от вида (деревня…мегаполис). Дома гарантированно **не наслаиваются**.
  Чтобы рассмотреть кварталы, уменьшите масштаб региона (10–20 км ≈ один город).
  Названия — реальные русские топонимы (Берёзовка, Озёрск, Горнозаводск…).
